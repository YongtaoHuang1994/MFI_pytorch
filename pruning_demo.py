...
module = model.conv1
print("original model paras: ====================")
print(list(module.named_parameters())) # 输出conv1的参数, 包含weight和bias


######################################################################
print("original model buffers: ====================")
print(list(module.named_buffers())) # 输出conv1的缓冲区, 空
...
print("pruned model paras after pruning weight: ====================")
...
print("pruned model buffers after pruning weight: ====================")
...
print("pruned model paras after pruning bias: ====================")
print(list(module.named_parameters()))
