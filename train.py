...
if __name__ == '__main__':
    ...
    train_dataset = MfiDataset(root_dir='./data28/train/',
                        names_file='./data28/train/train.csv',transform=ToTensor())
    test_dataset = MfiDataset(root_dir='./data28/test/',
                        names_file='./data28/test/test.csv',transform=ToTensor())
